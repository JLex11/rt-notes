...
// Datos originales en formato string
const originalNotes = [
	{
		id: 1,
...
// Convertir todas las notas al formato Yoopta-Editor
export const NOTES: Note[] = originalNotes.map(note => ({
	...note,
	content: convertTextToYoopta(note.content),
}))
