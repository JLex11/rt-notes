...
export const NOTES: Note[] = [
  ...
  },
  {
    ...
    content: `Es necesario actualizar las dependencias del proyecto antes del próximo release. Especial atención a las vulnerabilidades de seguridad reportadas en el último análisis.`,
  ...
  },
  {
    ...
    content: `Se han detectado problemas de rendimiento en producción. Necesario optimizar:\n- Queries a base de datos\n- Caché de imágenes\n- Bundle size de JavaScript\nPrioridad: ALTA`,
  ...
  },
  {
    ...
    content: `Actualizar la documentación de la API incluyendo:\n- Nuevos endpoints\n- Ejemplos de uso\n- Códigos de error\n- Rate limiting\n- Autenticación`,
  ...
  },
  {
    ...
    content: `No olvidar realizar el backup semanal de:\n- Base de datos\n- Archivos de configuración\n- Logs del sistema\nVerificar integridad después del backup.`,
  ...
  },
  {
    ...
    content: `Programar sesión de review de código con el equipo junior.\nTemas a cubrir:\n- Mejores prácticas\n- Patrones comunes\n- Manejo de errores\n- Optimización`,
  ...
  },
  {
    ...
    content: `Preparar presentación para el cliente incluyendo:\n- Avances del último mes\n- Métricas de rendimiento\n- Próximas funcionalidades\n- Demo del nuevo diseño`,
